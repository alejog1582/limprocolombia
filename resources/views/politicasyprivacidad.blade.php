...
<div class="row">
    <div class="col-sm-12">
        <p>
            ...
            <br><br>
            <b>Limpro</b> está altamente comprometido para cumplir con el compromiso de mantener su información segura. Usamos los sistemas más avanzados y los actualizamos constantemente para asegurarnos que no exista ningún acceso no autorizado.
            <br><br>
            <h2>COOKIES</h2>
            ...
            <br><br>
            Con la aceptacion de esta politica de privacidad autorizo a <b>Limpro</b>  a que sea de dominio publico las calificaciones dadas por el servicio prestado, con el fin que los demas usuarios puedan conocer la experencia vivida en cada servicio.
            <br><br>
            <b>Limpro</b>  Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier momento..
        </p>
    </div>
</div>
</div>
...
@section('title')
    Politica de Privacudad Limpro Colombia Limpieza Profesional
@endsection