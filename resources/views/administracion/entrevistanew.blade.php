...
<div class="container">
    <br>
    <h1 class="text-center">Nueva Entrevista Limpro Colombia</h1>
    <a class="btn" id="boton_principal" href="/administracion">Regresar</a>
    <br><br>
    <form action="/administracion/entrevista/save" method="POST">
        {{ csrf_field() }}
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="nombre_funcionaria_abreviado" name="nombre_funcionaria_abreviado" @if ($errors->has('nombre_funcionaria_abreviado')) is-invalid @endif>
            ...
            <div class="form-group col-md-4">
                ...
                <input type="date" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento" @if ($errors->has('fecha_nacimiento')) is-invalid @endif>
            ...
            <div class="form-group col-md-4">
                ...
                <input type="date" class="form-control" id="fecha_expedicion_cedula" name="fecha_expedicion_cedula" @if ($errors->has('fecha_expedicion_cedula')) is-invalid @endif>
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="tipo_sangre" name="tipo_sangre" @if ($errors->has('tipo_sangre')) is-invalid @endif>
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="eps" name="eps" @if ($errors->has('eps')) is-invalid @endif>
                @if ($errors->has('eps'))
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="pension" name="pension" @if ($errors->has('pension')) is-invalid @endif>
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="cuenta_ahorro" name="cuenta_ahorro" @if ($errors->has('cuenta_ahorro')) is-invalid @endif>
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="numero_cuenta_ahorro" name="numero_cuenta_ahorro" @if ($errors->has('numero_cuenta_ahorro')) is-invalid @endif>
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="operador_celular" name="operador_celular" @if ($errors->has('operador_celular')) is-invalid @endif>
        ...
        <div class="form-row">
            <div class="form-group col-md-1">
                ...
                <select id="cocina" class="form-control" name="cocina" @if ($errors->has('cocina')) is-invalid @endif>
                    <option selected>Sel. Opcion</option>
                    <option value="si">Si</option>
                    <option value="no">No</option>                                       
                </select>
                ...
                <select id="cafeteria" class="form-control" name="cafeteria" @if ($errors->has('cafeteria')) is-invalid @endif>
                    <option selected value="si">Sel. Opcion</option>
                    <option value="si">Si</option>
                    <option value="no">No</option>                                       
                </select>
            ...
            <div class="form-group col-md-2">
                ...
                <input type="date" class="form-control" id="fecha_manipulacion_alimentos" name="fecha_manipulacion_alimentos">                
            </div>
        </div>
        <div class="form-row">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="text" class="form-control" id="nombre_acudiente" name="nombre_acudiente" @if ($errors->has('nombre_acudiente')) is-invalid @endif>
            ...
            <div class="form-group col-md-3">
                ...
                <input type="text" class="form-control" id="celular_acudiente" name="celular_acudiente" @if ($errors->has('celular_acudiente')) is-invalid @endif>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <textarea class="form-control" id="trabajo_anterior" rows="4" name="trabajo_anterior" @if ($errors->has('trabajo_anterior')) is-invalid @endif></textarea>
            ...
            <div class="form-group col-md-6">
                ...
                <textarea class="form-control" id="experiencia_laboral" rows="4" name="experiencia_laboral" @if ($errors->has('experiencia_laboral')) is-invalid @endif></textarea>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <textarea class="form-control" id="fortalezas" rows="4" name="fortalezas" @if ($errors->has('fortalezas')) is-invalid @endif></textarea>
            ...
            <div class="form-group col-md-6">
                ...
                <textarea class="form-control" id="debilidades" rows="4" name="debilidades" @if ($errors->has('debilidades')) is-invalid @endif></textarea>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <textarea class="form-control" id="hijos" rows="4" name="hijos" @if ($errors->has('hijos')) is-invalid @endif></textarea>
                @if ($errors->has('hijos'))
            ...
            <div class="form-group col-md-6">
                ...
                <textarea class="form-control" id="conformacion_familia" rows="4" name="conformacion_familia" @if ($errors->has('conformacion_familia')) is-invalid @endif></textarea>
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="tipo_vivienda" name="tipo_vivienda" @if ($errors->has('tipo_vivienda')) is-invalid @endif>
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="tiempo_libre" name="tiempo_libre" @if ($errors->has('tiempo_libre')) is-invalid @endif>
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="disponibilidad_tiempo" name="disponibilidad_tiempo" @if ($errors->has('disponibilidad_tiempo')) is-invalid @endif>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <textarea class="form-control" id="estudios" rows="4" name="estudios" @if ($errors->has('estudios')) is-invalid @endif></textarea>
            ...
            <div class="form-group col-md-6">
                ...
                <textarea class="form-control" id="antecedentes_medicos" rows="4" name="antecedentes_medicos" @if ($errors->has('antecedentes_medicos')) is-invalid @endif></textarea>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <textarea class="form-control" id="concepto_entrevista" rows="4" name="concepto_entrevista" @if ($errors->has('concepto_entrevista')) is-invalid @endif></textarea>
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control" id="fecha_entrevista" type="date" name="fecha_entrevista" @if ($errors->has('fecha_entrevista')) is-invalid @endif>
