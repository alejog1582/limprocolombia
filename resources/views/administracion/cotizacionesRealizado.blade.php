...
<div class="container">
    ...
    <br>
    <h1 class="text-center">Cotizaciones Enviadas</h1>
                        ...
                        <li class="list-group-item card_secundaria">
                            <div class="row">
                                <div class="form-group col-sm-12 text-center">
                                    <form method="POST" action="/administracion/cotizacionesrealizadaschange/{{$cotizacion->id}}" >
                                    {{ csrf_field() }}
                                        <input type="hidden" name="id_funcionaria" value="{{ $cotizacion->id }}">
                                        <button type="submit" class="btn" id="boton_principal">Gestionado</button>
                                    </form>
                                </div>
                            </div>
                        </li>
