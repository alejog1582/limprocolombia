            ...
            <div class="card">
                ...
                <div class="card-body card_secundaria">
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <p>Hemos recibido la informacion exitosamente. En los proximos dias te estaremos llamando a entrevista. El numeo de ID de tu proceso es el: <b>{{$funcionaria->id}} </b></p>
